...
def pruneShapes(theList, cutoff):    #deleted shapes with point counts that fall below a given cutoff value. ie 'delete the specs'
...
def printGCode(theList): #prints the reconstituted gcode data from the co-ordinate values of the objects list. this output should match the input structure
	a_shapeData = []
	for shape in theList:
		print('\nM3 S165\n', end='')
		print('G0 F2000\n', end='')
...
###### executed in order, the effects are cumulative, so order should be load, then rotate/shift/scale, then sort, then analyze/print/save....
objectsList = loadandparse(theFile = '/Users/mccoy/Desktop/joined-figureOnly2f.gcode')
...
#splitRandom(objectsList)
#print('\n')
#analyzeShapes(objectsList)
#analyzeShapes(splitObjectsList)
#printHeader()
#printMinMax()
#printGCode(objectsList)
#print('\n')
#sortDirection(objectsList, True, False) 
#sortDirection(splitObjectsList, True, False) 
#writeGCode(objectsList, '/Users/mccoy/Desktop/tempBigger.gcode')
#writeGCode(splitObjectsList, '/Users/mccoy/Desktop/tempSmaller.gcode')
#print(workingList)
#print(objectsList)
#print('\n')
#print(newlist)
